...
const randomPhrase = document.querySelector("#phrases")
const phrases = [
...
clickCookie.addEventListener('click', handleGeneratePhrase)
btnAgain.addEventListener('click', handleAgainClick)
document.addEventListener('keydown', pressEnterKey)


function handleGeneratePhrase(event){
  event.preventDefault();
  toggleScreen()
  let generateRandomPhrase = Math.floor(Math.random()*(phrases.length));
